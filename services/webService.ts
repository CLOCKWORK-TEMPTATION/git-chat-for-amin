...
export const fetchUrlContent = async (
    ...
    try {
        ...
        if (contentLength && Number(contentLength) > MAX_HTML_BYTES) {
            throw new Error('Page content is too large to process safely.')
        }
        ...
        const scripts = doc.querySelectorAll(
            'script, style, link, nav, footer, iframe, svg, noscript, img, video, header, aside, .ad, .js-dismissable-hero'
        )
