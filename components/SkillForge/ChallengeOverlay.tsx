            ...
            <div className="bg-base w-full max-w-5xl h-[85vh] rounded-2xl border border-border-subtle shadow-2xl flex flex-col md:flex-row overflow-hidden relative">
                ...
                <div className="w-full md:w-1/3 p-6 bg-elevated-2 border-b md:border-b-0 md:border-l border-border-subtle overflow-y-auto">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-xs text-text-secondary bg-base px-2 py-1 rounded">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                        {challenge.relatedTags.map((tag) => (
                            <span
                                key={tag}
                                className="text-[10px] px-2 py-1 rounded-full border border-border-subtle text-tertiary"
                            >
                                #{tag}
                            </span>
                        ))}
                    ...
                    {result && (
                        <div
                            className={`mt-8 p-4 rounded-xl border ${result.isCorrect ? 'bg-success/10 border-success/30' : 'bg-error/10 border-error/30'} animate-slide-up`}
                        >
